...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-slate-800 pb-20 w-[85%] max-w-none mx-auto">
      {/* Header */}
      <header className="bg-white border-b border-gray-200 sticky top-0 z-10">
        <div className="w-full px-4 h-16 flex items-center justify-between">
          ...
          {result && (
            <button 
              onClick={reset}
              className="text-sm font-medium text-gray-500 hover:text-gray-800 flex items-center gap-2 px-3 py-1.5 rounded-md hover:bg-gray-100 transition-colors"
            >
      ...
      <main className="w-full px-4 py-8">
        ...
        <div className="mb-8 text-center max-w-2xl mx-auto">
          <h2 className="text-3xl font-bold text-gray-900 mb-3">Gestione Distinta Base Progetto</h2>
          <p className="text-gray-500">
            Carica i file Excel e la cartella locale dei disegni.
            Il sistema verificherà i dati e genererà uno script per copiare i file trovati (.pdf, .dwg, .stp).
          </p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center mb-10 gap-3">
          <button
            ...
            className={`
              relative px-10 py-4 rounded-xl font-bold text-lg shadow-lg transition-all transform hover:-translate-y-1 active:translate-y-0
              ${(!dbFile || !bomFile) 
